function [svmmodel,seq,train_set,trainstate] = train_SSRDCF_refine(seq,svmmodel,train_set)
...
for frame = 1:seq.len
    ...
    [params,data,train_set,trainstate] = ...
        Detection_trainRL_refine(params,data,anno,train_set);
